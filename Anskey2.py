...
(B) MySQL Stub Program: 


1. cn=mycon.connect(host="main_rajwadi", user="rajwadi_admin", passwd="Rajwadi@2023", database = "rajwadi")

2. cn.cursor()

3. cur.execute("delete from customer where customerid={}.format(cust_id)")
